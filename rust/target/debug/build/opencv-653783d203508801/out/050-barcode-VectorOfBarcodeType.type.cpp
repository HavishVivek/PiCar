extern "C" {
	...
	Result<cv::barcode::BarcodeType> cv_VectorOfBarcodeType_get(const std::vector<cv::barcode::BarcodeType>* instance, size_t index) {
		return Ok<cv::barcode::BarcodeType>((*instance)[index]);
	}
